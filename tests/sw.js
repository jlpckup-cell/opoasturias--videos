...
const CACHE='opoasturias-tests-v1-20260909:'+BASE.pathname;
const FILES=['./','./index.html','./styles.css','./app.js','./engine.js','./data/bank.json','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];

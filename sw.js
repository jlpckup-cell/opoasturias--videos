const VERSION='opoasturias-v6-written-topics-20260909';
const BASE=new URL('./',self.location.href);
const CACHE=VERSION+':'+BASE.pathname;
const FILES=['./','./index.html','./styles.css','./app.js','./state.js','./study.js','./study-ui.js','./android.js','./manifest.webmanifest','./data/catalog.json','./data/readings.json','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png','./icons/maskable-512.png','./COBERTURA.md'];
